Shader "Custom/cel"
{
    Properties
    {
        ...
        _SpecPower("Specular Power", Range(0, 100)) = 0.0
        _SpecScale("Specular Scale", Range(0, 10)) = 0.0
        _OutlineColor("Outline Color", Color) = (0,0,0,1)
        _OutlineThickness("Outline Thickness", Range(0,5)) = 0.25
    }
    SubShader
    {
        ...
        half4 LightingToonLighting(CustomSufaceOutput s, half3 lightDir,half3 viewDir, half atten)
        {
        ...
        void surf (Input IN, inout CustomSufaceOutput o)
        {
